...
Функціональний простір інтерфейсу адміністратора платформи дозволяє контролювати усі етапи тестування, від створення опитування до формування результатів після завершення респондентами тестування. 

Надаються можливості:
1. Створювати нові тестування, видаляти опитування та редагувати анкети, створені адміністратором або інтерв'юерами
2. Передавати створені опитування респондентам та передавати завершені тестування інтерв'юерам
