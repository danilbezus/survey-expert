...
|                          | 2. Система шукає користувача у базі даних користувачів та ідентифікує його (можлива v1.NOT_LOGGED.EX.004)  |      |                          | 3. Система перевіряє, чи існує задане опитування (можлива v1.COMMON.EX.001)                                |
|                          | 4. Система перевіряє, чи є доступ у користувача до заданого опитування; (можлива v1.COMMON.EX.002)         |      |                          | 5. Система перевіряє правильність даних про проходження користувачем опитування (можлива v1.COMMON.EX.003) |
