...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Organization` (`id`, `Name`, `Creating date`, `Description`, `Adress`, `Creator_Id`) VALUES (1, 'Funny posts', '2002-11-11', 'hehehehehehh', 'kyiv', 1);
INSERT INTO `mydb`.`Organization` (`id`, `Name`, `Creating date`, `Description`, `Adress`, `Creator_Id`) VALUES (2, 'Study tests', '2019-12-11', 'bad bad university', 'rivne', 2);
INSERT INTO `mydb`.`Organization` (`id`, `Name`, `Creating date`, `Description`, `Adress`, `Creator_Id`) VALUES (3, 'Angels only', '2020-12-12', 'TY NE ANGEL', 'heaven', 5);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Poll` (`id`, `Title`, `Description`, `Creation date`, `End date`, `IsPrivate`, `Link`, `Creator_Id`, `Organization_id`, `PollType_Id`) VALUES (1, 'Which OT teacher are you?', 'just for fun', '2020-12-12', '2021-01-01', 0, 'funny', 1, 1, 1);
INSERT INTO `mydb`.`Poll` (`id`, `Title`, `Description`, `Creation date`, `End date`, `IsPrivate`, `Link`, `Creator_Id`, `Organization_id`, `PollType_Id`) VALUES (2, 'Final exam', 'I WILL KILL YOU FOR THE WRONG ANSWERS!', '2021-12-12', '2021-12-12', 1, 'test', 2, 2, 3);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`PollResult` (`id`, `Date`, `Comment`, `Poll_id`, `User_id`) VALUES (1, '2021-10-12', 'I\'ve done with the bad uni', 2, 1);
INSERT INTO `mydb`.`PollResult` (`id`, `Date`, `Comment`, `Poll_id`, `User_id`) VALUES (2, '2021-12-20', 'I hope it will be all right :}', 2, 2);
...
[Source-код RESTfull сервісу](https://github.com/danilbezus/survey-expert/tree/master/src/js)
...
## RESTfull сервіс для управління даними (Код контроллерів):
...
## RESTfull сервіс для управління даними (Код серверу):
...
- `/questionfeedback` - (get) - Отримати список всіх вігуків на питанняя
- `/questionfeedback` - (post) - Створити відгук на ппитання
- `/questionfeedback/:id` - (get) - Отримати один відгук на ппитання за ID
- `/questionfeedback/:id` - (patch) - Оновити відгук на ппитання за ID
- `/questionfeedback/:id` - (delete) - Видалити відгук на ппитання за ID

- `/answer` - (get) - Отримати список всіх питань
- `/answer` - (post) - Створити одне питання
- `/answer/:id` - (get) - Отримати питання за його ID
- `/answer/:id` - (patch) - Оновити питання за його ID
- `/answer/:id` - (delete) - Видалити питання за його ID